//go:generate mockgen -destination=mocks/mock_signature_policy.go -package=mocks v2ray.com/core/app/porter/src/crypto SignaturePolicy
//go:generate mockgen -destination=mocks/mock_hash_policy.go -package=mocks v2ray.com/core/app/porter/src/crypto HashPolicy
